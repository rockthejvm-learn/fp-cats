package com.udavpit.fp.cats.data
...
object Writers {
  ...
  val aWriterWithBoth =
    aWriter.bimap(_ :+ "found something interesting", _ + 1) // both value and logs change
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(countAndLog(5).written)
    println(sumWithLogs(10).written)
  }
}
